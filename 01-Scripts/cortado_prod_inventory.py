#!/usr/bin/env python3
"""
AWS Resource Inventory with Rightsizing - Cortado Production Account
Generates two CSV files:
1. cortado_prod_ebs_inventory.csv - All EBS volumes
2. cortado_prod_compute_inventory.csv - EC2, RDS, and ECS resources with rightsizing
"""
...
# Configuration
ACCOUNT_NAME = "Cortado Production"
ACCOUNT_ID = "946447852237"
PROFILE_NAME = "srsa-cortado-prod"
ENV_HINT = "prod"
EBS_OUTPUT_FILE = "cortado_prod_ebs_inventory.csv"
COMPUTE_OUTPUT_FILE = "cortado_prod_compute_inventory.csv"
...
def get_cloudwatch_cpu_utilization(session, region, namespace, dimensions):
...
def get_rds_free_storage(session, region, db_instance_id):
    ...
    try:
        ...
        if response['Datapoints']:
            ...
            return round(avg_free_bytes / (1024**3), 2)
        return 0.0
    except Exception as e:
        return 0.0
