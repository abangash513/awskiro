#!/usr/bin/env python3
"""
AWS Resource Inventory with Rightsizing Recommendations - Charles Mount Account
Generates two CSV files:
1. charles_ebs_inventory.csv - All EBS volumes
2. charles_compute_inventory.csv - EC2, RDS, and ECS resources with rightsizing
"""
...
# Configuration
ACCOUNT_NAME = "Charles Mount"
ACCOUNT_ID = "198161015548"
PROFILE_NAME = "srsa-charles"
ENV_HINT = "prod-finance"
EBS_OUTPUT_FILE = "charles_ebs_inventory.csv"
COMPUTE_OUTPUT_FILE = "charles_compute_inventory.csv"
