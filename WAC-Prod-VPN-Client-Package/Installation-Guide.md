# WAC Production VPN - Installation Guide

Complete step-by-step instructions for installing and configuring the AWS VPN Client for Production environment access.
...
Ensure you have the file: **wac-prod-admin-vpn.ovpn**

⚠️ **IMPORTANT:** This file provides access to the PRODUCTION environment. Handle with extreme care.
...
5. Navigate to `wac-prod-admin-vpn.ovpn`
6. Select the file and click **Open**
7. In the **Display Name** field, enter: `WAC Prod Admin VPN`
8. Click **Add Profile**
9. Click **Done**
...
4. Click **Add Profile**
5. Browse to `wac-prod-admin-vpn.ovpn`
6. Display Name: `WAC Prod Admin VPN`
7. Click **Add Profile**

### Step 3: Verify Profile Import

You should now see "WAC Prod Admin VPN" in your profile list with:
- Status: Ready to connect
- Environment indicator: Production
- Server: cvpn-endpoint-xxxxx.prod.clientvpn.us-west-2.amazonaws.com
...
⚠️ **Before connecting to Production:**
- Ensure you have authorization
- Verify you're following change management procedures
- Confirm this is the appropriate time for Production access
...
You should see an IP address in the 10.200.0.0/16 range.

#### Test Connectivity to Production VPC:

```bash
ping 10.70.0.2
```

This should successfully ping the DNS server in the Production VPC.
...
Both Domain Controllers should respond.
...
- Verify Windows 10 64-bit or later
...
- [ ] Verify you have Production access authorization
- [ ] Review change management procedures
- [ ] Confirm maintenance window (if applicable)
- [ ] Have rollback plan ready
- [ ] Notify team of Production access

### Security Checklist

- [ ] Computer has full disk encryption enabled
- [ ] Strong password/PIN configured
- [ ] Screen lock enabled (5-minute timeout)
- [ ] Antivirus/security software up to date
- [ ] No screen sharing software running
- [ ] Working in secure location

---

## Auto-Start Configuration (Optional)

⚠️ **NOT RECOMMENDED for Production VPN**

Production VPN should be connected only when actively needed, not automatically.
...
5. **Securely delete** wac-prod-admin-vpn.ovpn file
...
**Securely delete OVPN file:**
```bash
shred -u wac-prod-admin-vpn.ovpn
```
...
2. ✅ Read **SECURITY-NOTICE.md** for Production policies
3. ✅ Test connectivity to Domain Controllers
4. ✅ Bookmark this guide for future reference
5. ✅ **DO NOT** configure auto-connect for Production

---

## Production Access Reminders
...
- Have specific task list ready
- Plan to disconnect after completion
...
3. Review CloudWatch logs: `/aws/clientvpn/prod-admin-vpn`
4. Contact your AWS administrator
5. **For Production issues:** Follow incident response procedures

---

## Compliance Notes

- All Production VPN connections are logged
- Connection logs retained for 180 days
...
**⚠️ PRODUCTION ENVIRONMENT - AUTHORIZED ACCESS ONLY**
