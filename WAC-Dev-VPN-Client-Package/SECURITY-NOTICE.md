# 🔒 SECURITY NOTICE - WAC Dev VPN Certificate
...
This package contains **authentication credentials** for accessing the WAC Development environment. Improper handling of these materials could result in **unauthorized access** to sensitive systems.
...
**These credentials provide direct access to:**
...
- Don't leave VPN connected unattended
- Disconnect when not actively using Dev resources
...
- Unexpected access to Dev resources
...
- **Authorization:** Must be explicitly granted by IT/Security
...
All VPN activity is logged to AWS CloudWatch:
...
- **Destination Access:** Resources accessed in Dev VPC
...
By using this VPN certificate, you agree to:

1. **Protect Credentials**
   - Maintain confidentiality of all authentication materials
...
By using this VPN certificate, you acknowledge that:

- [ ] I have read and understood this security notice
- [ ] I will protect these credentials as confidential information
- [ ] I will follow all security policies and procedures
- [ ] I will report any security incidents immediately
- [ ] I understand the consequences of misuse
